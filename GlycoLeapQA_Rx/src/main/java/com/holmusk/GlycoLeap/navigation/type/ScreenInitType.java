...
public interface ScreenInitType extends DashboardActionType, MealPageActionType {
     ...
     * {@link com.holmusk.GlycoLeap.navigation.Screen#USE_APP_NOW} after a
   ...
   default Flowable<?> rxn_useAppInitialized(@NotNull Engine<?> engine) {
    ...
    /**
     * When the app navigates to
     * {@link com.holmusk.GlycoLeap.navigation.Screen#PHOTO_PICKER}, two
   ...
   // @NotNull
    ...
    /**
     * When the app navigates to
     * {@link com.holmusk.GlycoLeap.navigation.Screen#MEAL_PAGE}, first-time
    ...
    /**
     * When the app navigates to
     * {@link com.holmusk.GlycoLeap.navigation.Screen#WEIGHT_ENTRY}, it
    ...
    /**
     * When the app navigates to {@link com.holmusk.GlycoLeap.navigation.Screen}
    ...
    //++++========================================================================
   @NotNull
    default Flowable<?> rxn_cardItemPageInitialized(@NotNull Engine<?> engine,@NotNull CardType card) {
       switch (card) {
           case MEAL:
